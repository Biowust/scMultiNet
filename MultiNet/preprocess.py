...
def read_dataset(adata, transpose=False, test_split=False, copy=False, fname='genes'):
    ...
    print('==> Successfully preprocessed {} {} and {} cells.'.format(adata.n_vars, fname, adata.n_obs))
    return adata
